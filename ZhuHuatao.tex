...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 \section{}
    ...
    \section{}
        ...
        \\
    \section{}
        Assume that $\|A\|$ is a finite nonnegative number.\\
        ...
        \[\|Ax_0\|=\sup_{\|y\|=1}\|Ay\|=\|A\|.\]
        If either $x_0$ or $ -x_0 $ is in the intersection of $S_x$ and $\mathbb{S}$, then
        \[
        max_{z \in S_x}\|Az\| \ge \|Ax_0\|=\|A\|.
        \]
        So we only need to prove the case that neither $x_0$ nor $-x_0$ are in the intersection of $S_x$ and $\mathbb{S}$.\\
        \\
    \section{}
        $(a)$:\\
